...
public class Grid {
  ...
  /**
   * This class represents a Rect within a Sudoku {@link Grid}. <br><br> It features a couple of
   * convenient methods.
   */
  public static class Cell {
    ...
    /**
     * Returns the value of the Rect. <br><br> The value is a digit (1, ..., 9) or 0 if the Rect is
     * empty.
     *
    ...
    /**
     * Indicates whether the Rect is empty or not.
     *
     * @return true if the Rect is empty, false otherwise
     */
    ...
    /**
     * Allows to change the value of the Rect.
     *
     * @param value the new value of the Rect
     */
    ...
    /**
     * Returns a {@link Collection} of all other Cells in the same row than this Rect.
     *
    ...
    /**
     * Returns a {@link Collection} of all other Cells in the same column than this Rect.
     *
    ...
    /**
     * Returns a {@link Collection} of all other Cells in the same box than this Rect.
     *
    ...
    /**
     * Returns the next Rect consecutive to this Rect. <br><br> This function returns the Rect to
     * the right of each Rect if the Rect is not the last Rect in a row. It returns the first Rect
     * of the next row of each Rect if the Rect is the last Rect in a row. For the very last Rect in
     * the very last row this function returns null.
     *
     * @return the next Rect consecutive to this Rect or null if it is the last Rect.
     */
    ...
    /**
     * Allows to set a Rect which is interpreted to be the next Rect consecutive to this Rect.
     *
     * @param nextCell the next Rect consecutive to this Rect.
     */
